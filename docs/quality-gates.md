...
The local 45-check journey now also proves the full Capability Forge path in the
...
public count remains the previously deployed 42-check evidence until the new
release is deployed and the same real-model journey is archived again.
