...
function BoardRoomBuilder({ snapshot, mutate, busy, onCancel, onCreated }) {
  ...
  const [form, setForm] = useState({
    ...
    editor: { name: "Dissent Editor", model: models[0], instructions: "Synthesize the completed participant records without erasing material disagreement, failed members, open questions, or citations.", reasoning_effort: "high", max_output_tokens: 4000 },
    quorum: 2,
