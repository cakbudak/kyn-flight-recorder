  ...
  "barrier": {
    ...
    "on_member_error": "isolate"
          ...
          <DocSection id="runs" number="08" kicker="Operations" title="Observe and control work as Runs">
            ...
            <Callout tone="ai" title="Human gates are state, not UI">An approval Action moves the Step and Run into <code>waiting_approval</code>. The decision stores actor and reason. Approval resumes through the explicit approved route; rejection resumes through an explicit rejected route when one exists, otherwise it fails closed. Refreshing or closing the page does not bypass the gate.</Callout>
          </DocSection>
